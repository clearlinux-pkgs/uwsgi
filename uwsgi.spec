...
Version  : 2.0.18
Release  : 62
URL      : https://github.com/unbit/uwsgi/archive/2.0.18/uwsgi-2.0.18.tar.gz
Source0  : https://github.com/unbit/uwsgi/archive/2.0.18/uwsgi-2.0.18.tar.gz
...
%prep
%setup -q -n uwsgi-2.0.18
cd %{_builddir}/uwsgi-2.0.18
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590631296
...
cp %{_builddir}/uwsgi-2.0.18/LICENSE %{buildroot}/usr/share/package-licenses/uwsgi/ba8b424d462ab14f383ebc73adb43067c72e3a7f
