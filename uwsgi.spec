...
Version  : 2.0.29
Release  : 92
URL      : https://github.com/unbit/uwsgi/archive/2.0.29/uwsgi-2.0.29.tar.gz
Source0  : https://github.com/unbit/uwsgi/archive/2.0.29/uwsgi-2.0.29.tar.gz
...
%prep
%setup -q -n uwsgi-2.0.29
cd %{_builddir}/uwsgi-2.0.29
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a uwsgi-2.0.29 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744729904
