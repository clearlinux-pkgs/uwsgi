...
Source0  : https://github.com/unbit/uwsgi/archive/2.0.19/uwsgi-2.0.19.tar.gz
...
%prep
%setup -q -n uwsgi-2.0.19
cd %{_builddir}/uwsgi-2.0.19
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592238410
...
cp %{_builddir}/uwsgi-2.0.19/LICENSE %{buildroot}/usr/share/package-licenses/uwsgi/ba8b424d462ab14f383ebc73adb43067c72e3a7f
