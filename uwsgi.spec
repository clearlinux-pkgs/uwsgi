...
Version  : 2.0.28
Release  : 91
URL      : https://github.com/unbit/uwsgi/archive/2.0.28/uwsgi-2.0.28.tar.gz
Source0  : https://github.com/unbit/uwsgi/archive/2.0.28/uwsgi-2.0.28.tar.gz
...
%prep
%setup -q -n uwsgi-2.0.28
cd %{_builddir}/uwsgi-2.0.28
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a uwsgi-2.0.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730157219
